...
- [Courtyard repair](COURTYARD_REPAIR.md): the repaired playable baseline.
- [Development status](../DEVELOPMENT_STATUS.md): implemented work, evidence, and the next milestone.

Original setting and franchise documents remain in the repository root. Proposed art does not change their canon.
